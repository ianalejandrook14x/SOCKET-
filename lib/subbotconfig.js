...
export function getSubbotConfig(botJid, defaultConfig) {
    ...
    try {
        ...
        if (cleanNumber && data[cleanNumber]) {
            ...
            return {
                name: subData.name || defaultConfig?.botName || config?.botName || 'sᥲtsυkι tᥲᥴhιbᥲᥒᥲ',
                ownerName: subData.ownerName || defaultConfig?.ownerName || 'tᥱwιᥲᥒιx',
        ...
        return {
            name: defaultConfig?.botName || config?.botName || 'sᥲtsυkι tᥲᥴhιbᥲᥒᥲ',
            ownerName: defaultConfig?.ownerName || 'tᥱwιᥲᥒιx',

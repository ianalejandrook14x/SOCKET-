...
ʚĭɞ ೃ codigo :: lib/subbots.js
ʚĭɞ ೃ funcion :: generar codigo , crear , guardar , activar , desactivar y reconexion de subbots
...
async function initializeSubBot(
    ...
    if (
        ...
        console.log(
            `⚠️ El subbot ${jid} ya se está iniciando.`
        )
    ...
    if (
        ...
        console.log(
            `⛔ El subbot ${jid} fue detenido manualmente.`
        )
            ...
            async ({
                ...
                if (
                    ...
                    if (
                        ...
                        console.log(
                            `⛔ Subbot detenido manualmente: ${jid}`
                        )
...
async function stopSubBot(jid) {
    ...
    if (
        ...
        console.log(
            `⚠️ No hay socket activo para ${jid}`
        )
